...
public class ModItems {
    ...
    public static final RegistryObject<Item> STEEL_PLATE = ITEMS.register("steel_plate",
            () -> new ArmorPlateItem(PlateTier.STEEL, new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> CERAMIC_PLATE = ITEMS.register("ceramic_plate",
            () -> new ArmorPlateItem(PlateTier.CERAMIC, new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> COMPOSITE_PLATE = ITEMS.register("composite_plate",
            () -> new ArmorPlateItem(PlateTier.COMPOSITE, new Item.Properties().stacksTo(1)));
}
